...
function Sidebar() {
  ...
  return (
	...
	<div className="flex items-center p-2 space-x-4">
          ...
          <img src={`http://localhost:8585/faculty/${storedProfilePicture}`}alt="hii" className="w-12 h-12 rounded-full dark:bg-gray-500" />
	...
	<div className="divide-y dark:divide-gray-300">
		<ul className="pt-2 pb-4 space-y-1 text-sm">
			...
			<li>
				<NavLink to={`/add-course/${fID}`} rel="noopener noreferrer" href="#" className="flex items-center p-2 space-x-3 rounded-md">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current dark:text-gray-600">
			...
			<li>
				<NavLink to={`/edit-course/${fID}`} rel="noopener noreferrer" href="#" className="flex items-center p-2 space-x-3 rounded-md">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current dark:text-gray-600">
